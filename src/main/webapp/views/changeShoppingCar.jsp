    ...
    <script>
        ...
        function changeNumbers(obj,price,bookId,stock){
            if(isNaN(obj.value)){
                ...
                //修改每本图书的订购金额
                obj.parentNode.nextSibling.innerHTML = "￥" + (obj.value * price);
                var url = "changeShoppingCar?&curNums="+obj.value;
                location.href = url;
            }
        }
        //移除订单
        function clearOrder(bookId){
            var url = "changeShoppingCar?&curNums=0";
            location.href = url;
        }
...
<div id="content" class="wrap">
    <div class="list bookList">
        <form method="post" name="shoping" action="shopping-result">
            <table id="mytable">
                <tr class="title">
                ...
                <c:forEach var="book" items="${shoppingList}">
                    <tr>
                        ...
                        <td><input class="input-text" type="text" name="nums" value="${shoppingMap[book.bid] }" onblur="changeNumbers(this,sum,obj.value,${book.stock})"/></td>
        ...
        <c:if test="${empty shoppingList}">
            <div class="emptyshopping">您的购物车空空如也!快去<a href="#">选购图书</a>吧</div>
        </c:if>
